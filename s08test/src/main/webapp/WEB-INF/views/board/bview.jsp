		...
		<div>
			...
			<table>
				...
				<tr>
		     	 ...
		     	 <tr>
        <td colspan="2"><strong>다음글</strong> <span class="separator">|</span> <a href="bview?bno=${next.bno }">${next.btitle }</a> </td>
      </tr>
      <tr>
        <td colspan="2"><strong>이전글</strong> <span class="separator">|</span> <a href="bview?bno=${prev.bno }">${prev.btitle }</a> </td>
      </tr>
			</table>
	...
	function comBtn(){
		...
		$.ajax({
			...
			success: function(data){
				...
				var str='';
				str+='<ul id='+data.cno+'>';
				str+='<li class="name"> '+data.member.id+' <span>[ '+data.cdate+' ]</span></li>';
